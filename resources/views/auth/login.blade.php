...
<head>
    ...
    <meta name="description" content="Admin Login - Mega Santosa Tour & Travel">
    <meta name="author" content="Mega Santosa Tour & Travel">

    <title>{{ $title }} - Mega Santosa Admin</title>
    ...
    <main class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-6 pt-8 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
            <a href="{{ route('home.index') }}">
                <img src="{{ $logoUrl }}" width="160" class="" alt="Mega Santosa Logo">
            </a>
            <!-- Card -->
            <div class="w-full max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                @if (session('success'))
                    <div
                        class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-green-900/20 dark:text-green-400">
                        {{ session('success') }}
                    </div>
                @endif
                ...
                @if (session('error'))
                    <div
                        class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-red-900/20 dark:text-red-400">
                        {{ session('error') }}
                    </div>
                @endif
