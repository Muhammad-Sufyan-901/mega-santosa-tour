...
<head>
    ...
    <title>Mega Santosa Tour | Admin {{ $title ?? 'Dashboard' }}</title>

    <!-- Favicon -->
    @php
        $content = app(App\Http\Controllers\ContentController::class)->getContent();
        $faviconUrl = $content->favicon ? asset('assets/images/favicon/' . $content->favicon) : asset('assets/images/logo-mega-santosa.png');
        $logoUrl = $content->logo ? asset('assets/images/logo/' . $content->logo) : asset('assets/images/logo-mega-santosa.png');
    @endphp
        ...
        <div class="px-3 py-2 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a href="{{ route('admin.dashboard.index') }}" class="flex ml-2 md:mr-24">
                        <img src="{{ $logoUrl }}" width="60" class="h-60 w-16"
                            alt="Mega Santosa Tour Logo">
                        {{-- <span
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                            ...
                            <div class="px-4 py-3" role="none">
                                <p class="text-sm text-gray-900 dark:text-white" role="none">
                                    Admin Mega Santosa Tour
                                </p>
                                <p class="text-sm font-medium text-gray-900 truncate dark:text-gray-300"
                                    role="none">
                                    admin@megasantosatour.com
                                </p>
                            </div>
    ...
    <div class="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
                        ...
                        <ul class="pb-2 space-y-2">
                            ...
                            <li>
                                <a href="{{ route('admin.orders.index') }}"
                                    ...
                                    <span class="ml-3" sidebar-toggle-item>Pesanan</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.content.index') }}"
                                    ...
                                    <span class="ml-3" sidebar-toggle-item>Manajemen Konten</span>
                                </a>
                            </li>
                            <li>
                                <button type="button"
                                    class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                    aria-controls="layanan" data-collapse-toggle="layanan">
                                    <svg class="w-6 h-6 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                                    ...
                                    <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                        sidebar-toggle-item>Layanan</span>
                                ...
                                <ul id="layanan" class="hidden py-2 space-y-2">
                                    <li>
                                    ...
                                    <li>
                                        <a href="{{ route('admin.services.create') }}"
                                            class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Tambah
                                            Layanan</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <button type="button"
                                    class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                    aria-controls="testimoni" data-collapse-toggle="testimoni">
                                    <svg class="w-6 h-6 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" fill="currentColor" viewBox="0 0 24 24">
                                        <path fill-rule="evenodd"
                                    ...
                                    <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                        sidebar-toggle-item>Testimoni</span>
                                    <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                                            d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                ...
                                <ul id="testimoni" class="space-y-2 py-2 hidden ">
                                    <li>
                                        <a href="{{ route('admin.testimonials.index') }}"
                                            class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Data
                                            Testimoni</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.testimonials.create') }}"
                                            class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Tambah
                                            Testimoni</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <button type="button"
                                    class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                    aria-controls="galeri" data-collapse-toggle="galeri">
                                    <svg class="w-6 h-6 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" fill="currentColor" viewBox="0 0 24 24">
                                        <path fill-rule="evenodd"
                                    ...
                                    <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                        sidebar-toggle-item>Galeri</span>
                                    <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                                            d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                ...
                                <ul id="galeri" class="space-y-2 py-2 hidden ">
                                    <li>
        ...
        <div id="main-content" class="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900">
            ...
            <p class="my-10 text-sm text-center text-gray-500">
                &copy; {{ date('Y') }} <a href="#" class="hover:underline" target="_blank">Mega Santosa
                    Tour</a>. All rights reserved.
            </p>
